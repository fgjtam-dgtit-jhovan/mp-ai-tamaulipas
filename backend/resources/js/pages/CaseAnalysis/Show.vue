...
<template>
    ...
    <main class="min-h-screen bg-[#f4f7f6] text-slate-900">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div v-if="form.errors.analysis" class="mt-5 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
                <AlertCircle class="mt-0.5 size-5 shrink-0" />
                <span>{{ form.errors.analysis }}</span>
            </div>
